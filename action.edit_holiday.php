<?php
	...
	if( isset($params['cancel']) ) {
		...
		if( is_object($module) ) {
			if( !$holiday->published ) {
				...
				$search->AddWords($this->GetName(), $holiday->id, 'holiday', $holiday->name.' '.strip_tags($holiday->description));
			}
		}
	...
	$tpl = $smarty->CreateTemplate($this->GetTemplateResource('edit_holiday.tpl'),null,null, $smarty);
